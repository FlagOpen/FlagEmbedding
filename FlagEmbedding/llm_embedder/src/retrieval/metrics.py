...
class RetrievalMetric:
    ...
    @staticmethod
    def collate_key(eval_data, save_name, corpus, key_save_path=None, **kwds):
        """
    ...
    @staticmethod
    def collate_neg(eval_data, save_name, corpus, max_neg_num=100, filter_answers=False, **kwds):
        """
        ...
        def collate(query_ids, preds, **kwargs):
            ...
            save_path = RetrievalMetric._get_save_path(eval_data, output_dir=None, field="neg", save_name=save_name)
    ...
    @staticmethod
    def collate_score(eval_data, save_name, **kwds):
        """
        ...
        def collate(query_ids, preds, scores, **kwargs):
            ...
            save_path = RetrievalMetric._get_save_path(eval_data, output_dir=None, field="scored", save_name=save_name)
